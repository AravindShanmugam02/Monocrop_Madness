...
## Technical Details
### $${\textsf{\color{lime}3Cs}}$$
#### $${\textsf{\color{orange}Camera, Character, Control}}$$
Basic character, camera movement and control implemented from scratch.<br/>
<details>
...
### $${\textsf{\color{lime}AI}}$$
#### $${\textsf{\color{orange}AI Character}}$$
AI's behaviour is based on a <ins>Hierarchical Finite State Machine</ins> (HFSM).<br/>
$${\textsf{\color{gray}[Place Holder for AI states diagram overview]}}$$
<details>
 <summary>$${\textsf{\color{teal}Video}}$$</summary>
...
#### $${\textsf{\color{orange}AI Vision}}$$
AI has a <ins>Field Of View</ins> to detect player during patrol state.<br/>
<details>
 <summary>$${\textsf{\color{teal}Video}}$$</summary>
...
### $${\textsf{\color{lime}Other Core Gameplay Mechanics}}$$
#### $${\textsf{\color{orange}Farm}}$$
...
#### $${\textsf{\color{orange}Save, Load and Delete}}$$
...
$${\textsf{\color{gray}[Place Holder for video]}}$$<br/>

### $${\textsf{\color{lime}UI}}$$
#### $${\textsf{\color{orange}Crosshair}}$$
